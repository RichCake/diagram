...
**Требования** — это зафиксированные потребности или условия, которым должно соответствовать разрабатываемое программное обеспечение для решения задачи или достижения цели. **Классификация** требований включает функциональные (что система должна делать) и нефункциональные (как система должна это делать – производительность, безопасность, удобство использования и т.д.), а также бизнес-требования, пользовательские требования и системные требования.
...
- **Нефункциональные требования:** характеристики системы, такие как производительность, безопасность, надежность.
...
**Стандарты:** ISO/IEC/IEEE 29148 (стандарт для процессов жизненного цикла требований), BABOK Guide (Body of Knowledge для бизнес-анализа).
...
**Стандарты кодирования** — это набор правил и рекомендаций для написания исходного кода, направленный на улучшение читаемости, поддерживаемости и качества кода. Включают правила именования переменных, форматирования, комментариев, структуры кода. **Примеры:** PSR (PHP Standard Recommendations), Google Java Style Guide, PEP 8 (Python).
...
**Стандарты качества программной документации** обеспечивают единообразие, полноту, точность и поддерживаемость документов. **Примеры:**
- **ISO/IEC/IEEE 12207:** стандарт жизненного цикла ПО, включает требования к документации.
- **IEEE Std 830-1998:** Рекомендуемая практика для спецификаций программных требований (SRS).
- **ГОСТ 19 и ГОСТ 34:** российские стандарты на разработку и документацию ПО.
...
7. **Требования к составу и содержанию документации:** Перечень документов.
8. **Источники разработки:** Нормативные документы, стандарты.

24.  **Использование языка UML при проектировании сложных программных систем.**

**UML** широко используется при проектировании сложных систем для:
- **Визуализации:** Представление структуры и поведения системы в графическом виде.
- **Спецификации:** Точное определение требований и архитектуры.
- **Конструирования:** Генерация кода из моделей или использование моделей как основы для реализации.
- **Документирования:** Создание исчерпывающей документации по системе. Позволяет разбить сложную систему на более мелкие, управляемые части, показать их взаимодействие и зависимости, что упрощает понимание и управление сложностью.
...
- Итеративный процесс.    
- Должно быть независимым (желательно).
...
- **GitLab, GitHub, Bitbucket:** Для управления репозиториями кода и CI/CD. **Основная цель управления жизненным циклом программных средств:** Обеспечить создание высококачественного программного обеспечения, которое соответствует требованиям пользователя и бизнеса, в рамках бюджета и в установленные сроки, а также обеспечить его эффективное сопровождение и развитие.
